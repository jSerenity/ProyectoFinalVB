...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <div class="row">
    ...
    <asp:TextBox ID="txtindice" runat="server" class="form-control"  Enabled="false"></asp:TextBox>
        </div>
    

        <div class="form-group">
            <asp:Label ID="Label8" runat="server" Text="Facultad" class="col-sm-2 control-label"></asp:Label>
    <asp:DropDownList ID="cbFacultad" runat="server" AutoPostBack="true" EnableViewState="true" OnSelectedIndexChanged="cbFacultad_SelectedIndexChanged" DataTextField="facultad" DataValueField="codigo" class="form-control"  Enabled="false"></asp:DropDownList>
    
        </div>

        <div class="form-group">
            <asp:Label ID="Label9" runat="server" Text="Carrera" class="col-sm-2 control-label"></asp:Label>
        <asp:DropDownList ID="cbcarreras" runat="server" class="form-control"  Enabled="false"></asp:DropDownList>
            </div>
        
        <div class="form-group">
                <asp:Label ID="Label10" runat="server" Text="Sexo" class="col-sm-2 control-label"></asp:Label>
     <asp:DropDownList ID="cbsexo" runat="server" class="form-control"  Enabled="false">
